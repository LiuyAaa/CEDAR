...
void SIG1::getAnalysisUsage(AnalysisUsage& AU) const {
	ModulePass::getAnalysisUsage(AU);
}

SIG1::BBNode::BBNode(BasicBlock* no, int nu){
    node = no;
    num = nu;
    sig = 0;
    sigDiff = 0;
...
void SIG1::BBNode::addEdge(BasicBlockEdge* e, int n){
	edges.push_back(e);
	edgeNums.push_back(n);   
}

void SIG1::BBNode::removeEdge(int n){
	int i;
...
std::string SIG1::BBNode::printNode(){
...
void SIG1::insertErrorFunction(Module &M, StringRef name) {
...
void SIG1::createErrorBlocks(Function &F) {
	//Create an error handler block for each function
...
bool SIG1::shouldSkipF(StringRef name){
...
void SIG1::populateGraph(Module &M){
	int i = 0;
...
int SIG1::getIndex(BasicBlock* bb){
...
void SIG1::checkBuffSig(BBNode* parent, BBNode* buff, BBNode* child){
...
void SIG1::updateEdgeNums(BBNode* pred, BBNode* buff, BBNode* succ){
...
void SIG1::updatePhiNodes(BBNode* pred, BBNode* buff, BBNode* succ){
...
void SIG1::updateBranchInst(BBNode* pred, BBNode* buff, BBNode* succ){
...
unsigned short SIG1::getSingleSig(){
...
SIG1::BBNode* SIG1::insertBufferBlock(SIG1::BBNode* pred, SIG1::BBNode* succ){
...
bool SIG1::shouldSkipBB(StringRef name){
...
unsigned short SIG1::calcSigDiff(SIG1::BBNode* pred, SIG1::BBNode* succ){
...
void SIG1::printGraph(){
	for(BBNode* bn : graph){
		errs() << bn->printNode();
	}
}

GlobalVariable* SIG1::setUpGlobal(Module &M, StringRef vName, IntegerType* IT1){
...
void SIG1::insertStoreInsts(BBNode* bn, IntegerType* IT1, GlobalVariable* RTS,
...
void SIG1::insertCompInsts(BBNode* bn, IntegerType* IT1, GlobalVariable* RTS,
...
Instruction* SIG1::getInstructionBeforeOrAfter(Instruction* insertAfter, int steps){
...
Instruction* SIG1::isInBB(BasicBlock* BB){
...
std::list<SIG1::BBNode*> SIG1::getRetBBs(Function* F){
	std::list<SIG1::BBNode*> retBBs;
...
void SIG1::updateCallInsts(CallInst* callI, BBNode* bn, IntegerType* IT1,
...
void SIG1::verifyCallSignatures(IntegerType* IT1){
...
void SIG1::updateRetInsts(IntegerType* IT1){
...
void SIG1::splitBlocks(Instruction* I, BasicBlock* errBlock){
...
bool SIG1::runOnModule(Module &M) {
	passTime = clock();
